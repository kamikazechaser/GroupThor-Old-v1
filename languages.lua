return {
    en = {
        ...
        getban = {
            ...
            arab = 'Removed for Telegram Link posting: ',
        ...
        help = {
            mods = {
                ...
                media = "*Moderators: media settings*\n\n"
                        ...
                        .."`!warnmax media [number]` = set the max number of warnings before be kicked/banned for has sent a forbidden media.\n"
                ...
                char = "*Moderators: special characters*\n\n"
                        ...
                        .."Here you will find two particular options: _Telegram Links and RTL_.\n"
                        .."\n*Telegram Links*: when it's not allowed (🚫), everyone who posts a Telegram Link will be kicked from the group.\n"
                        .."*Rtl*: it stands for 'Righ To Left' character eg Hindi, Arabic etc, and it's the responsible of the weird service messages that are written in the opposite sense.\n"
            ...
            all = '*Commands for all*:\n'
                    ...
                    ..'`!f` <feedback> : send a feedback/report a bug/ask a question to my creator. _ANY KIND OF SUGGESTION OR FEATURE REQUEST IS WELCOME_. He will reply ASAP\n'
                    ..'`!help` : show this message.'
		            ..'\n\nIf you like this bot, please leave the vote you think it deserves [here](https://telegram.me/storebot?start=groupthorbot)',
		    private ='Hi, *&&&1*!\n'
                    ..'\nI\'m A Simple Group Management Bot.\n'
                    ..'\n*📍Change Log*\n'
                    ..'1⃣Fully Updated To v3.2\n'
                    ..'2⃣Strict Anti-Telegram Link Posting\n'
                    ..'3⃣Bot is Now [Open-Source](https://github.com/kamikazechaser/GroupThorBot)\n'            
                    ..'\n*✅Features*\n'
                    ..'1⃣Anti-Telegram Links\n'
                    ..'2⃣Anti-Media Posting\n'
                    ..'3⃣Ban/Kick By Reply\n'
                    ..'4⃣Working Ban List\n'
                    ..'5⃣Warn By Reply Which Automatically Kicks After The Max Warns\n'
                    ..'\n*❗️NFO*\n'
                    ..'1⃣Use `!` Before Commands\n'
                    ..'2⃣Contact Me By Using `!f <YOUR MESSAGE>`\n'
                    ..'3⃣Bot *MUST* Be Made Admin\n'
                    ..'4⃣If The Group Is Public, A Ban Is Preffered Over A Kick\n'
                    ..'5⃣Banhammer Commands Work With Reply\n'
                    ..'\n*🔰Adding The Bot*\n'
                    ..'1⃣Go To Administrators\n'
                    ..'2⃣Search For `@GroupThorBot` And Add As Administrator\n'
                    ..'3⃣In the group, Type `!help` To List The Commands\n'
                    ..'4⃣Owner Can be Set By Replying At Any of The Owners Message with `!owner` Command\n'
                    ..'\n*🌀Quick Settings* _type in group_\n'
                    ..'1⃣`!menu`\n'
                    ..'2⃣`!media`\n'
                    ..'3⃣`!dashboard`\n'
                    ..'4⃣`!antiflood`\n'
                    ..'\n*🔨Extra Commands*\n'
                    ..'1⃣`!ping`:Checks If Bot Is Online\n'
                    ..'2⃣`!tell`:Reply To A User To Return His User Info\n'
                    ..'3⃣`!info`:Returns General Info\n'
                    ..'4⃣`!help`:Returns List Of Commands When Typed In A group\n'
                    ..'5⃣`!banlist`:Returns List Of Users Who Have Been Kicked\n',
        ...
        links = {
            ...
            poll_setted = 'The link has been setted.\n*Vote here*: [&&&1](&&&2)',
	...
	es = {
        ...
        help = {
            mods = {
                ...
                char = "*Moderators: special characters*\n\n"
                        .."`!menu` = you will receive in private the menu keyboard.\n"
                        .."Here you will find two particular options: _telegram Link and RTL_.\n"
                        .."\n*telegram Link*: when telegram Link it's not allowed (🚫), everyone who will write an telegram Link character will be kicked from the group.\n"
        ...
        settings = {
            disable = {
                ...
                flood_locked = 'Anti-flood is now off',
                arab_locked = 'Anti-caracteres telegram Linke desactivado',
            ...
            enable = {
                ...
                flood_unlocked = 'Anti-flood is now on',
                arab_unlocked = 'Anti-caracteres telegram Linke apagado',
            ...
            char = {
                arab_kick = 'Senders of telegram Link messages will be kicked',
                arab_ban = 'Senders of telegram Link messages will be banned',
                arab_allow = 'telegram Link language allowed',
                rtl_kick = 'The use of the RTL character will lead to a kick',
                rtl_ban = 'The use of the RTL character will lead to a ban',
                rtl_allow = 'RTL character allowed',
            },
        ...
        preprocess = {
            ...
            arab_kicked = '&&&1 *expulsado*: mensaje telegram Linke detectado',
            rtl_banned = '&&&1 *banned*: rtl character in names/messages not allowed!',
            arab_banned = '&&&1 *banned*: telegram Link message detected!',
            flood_motivation = 'Banned for flood',
            media_motivation = 'Sent a forbidden media',
            first_warn = 'This type of media is *not allowed* in this chat.'
        },
    ...
    br = {
        ...
        getban = {
            ...
            arab = 'Removido por caracteres telegram Linkes: ',
